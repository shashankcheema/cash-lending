## Render-Safe Diagrams Auto-generated
The following diagrams are derived from the canonical versions and sanitized for strict Mermaid renderers.
...
sequenceDiagram
 ...
 J->>FB: Run for date=D
 FB->>T: Query derived feature inputs where datets=D and direction=credit
 T-->>FB: txns[]
